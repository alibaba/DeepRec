...
static const char* model_config = "{ \
    ...
    \"checkpoint_dir\": \"/home/deeprec/DeepRec/modelzoo/features/EmbeddingVariable/WDL/result/\", \
    \"savedmodel_dir\": \"/home/deeprec/DeepRec/modelzoo/features/EmbeddingVariable/WDL/savedmodels/1658589037/\" \
  } ";



struct input_format39{
	float I1;
  float I2;
  float I3;
  float I4;
...
::tensorflow::eas::ArrayProto get_proto_i(int char_input,int dim,::tensorflow::eas::ArrayDataType type){
  ::tensorflow::eas::ArrayShape array_shape;
  array_shape.add_dim(1);
  // array_shape.add_dim(1);
  ::tensorflow::eas::ArrayProto input;
  input.add_int64_val(char_input);
  input.set_dtype(type);
  *(input.mutable_array_shape()) = array_shape;
...
int main(int argc, char** argv) {
  ...
  for(int ii = 0; ii < rows; ii++ ){
        ...
        inputs.I10 = (int)atoi(all_elems[start_idx+9]);
        ...
        ::tensorflow::eas::ArrayProto I10 = get_proto_i(inputs.I10,1,dtype_i);
